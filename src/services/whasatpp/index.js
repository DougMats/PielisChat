...
const WhatsApp = () => ({
  ...
  GetConversation: async (jid, cursor_data) => {
    ...
    // console.log("douglas jid:", jid)
    // console.log("douglas cursor:", cursor_data)
    // console.log("ruta: ", `${ApiWhatsapp}/whatsapp/get/conversation`)
    ...
    //    console.log("................. nuevos mensaje capturados ", response.data.messages.length)
    ...
    const conversations = Promise.all(response.data.messages.map(async (item2, key2) => {
      let userType
      if (item2.key.fromMe == false) {
        userType = "receiver"
      } else {
  ...
  SendMmessageText: async (messageObj, user, name, id) => {
  ...
  SendMmessageImage: async (image, user, name, id) => {
    var bodyFormData = {
      image,
      user,
      user_name: name,
    ...
    console.log("logic send image")
    console.log(`${ApiWhatsapp}/whatsapp/send/message/image`)
    ...
    SendMmessageAudio: async (audio, user, name, id) => {
      var bodyFormData = {
        audio,
        user,
        user_name: name,
    ...
    SendMmessageVideo: async (video, user, name, id) => {
      var bodyFormData = {
        video,
        user,
        user_name: name,
    ...
    SendMmessageDocuments: async (file, user, extension, name, id) => {
      var bodyFormData = {
        file,
        extension,
        user,
