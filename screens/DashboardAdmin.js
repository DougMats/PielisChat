...
function DashboardAdmin(props) {
  ...
  function SelectMany(value) {
    ...
    if (selectList.length === 0) {
      ...
      if (Updating === undefined) { console.log("no existe"); setselectList([...selectList, array]) }
      else {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <ImageBackground source={require('../images/background_1.png')} style={{ flex: 1, justifyContent: "flex-start", resizeMode: "cover", width: "100%", height: "100%" }}>
