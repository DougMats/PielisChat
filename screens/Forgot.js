...
<View style={{backgroundColor:"orange"}}>
        ...
        <Text>Ingresa tu número telefónico</Text>
        ...
        <View style={styles.options}>
          ...
          <TouchableOpacity onPress={() => goToScreen("Login")} style={styles.optionsBtn}>
            <Text style={styles.optionsBtnText}>Iniciar Sesión</Text>
          </TouchableOpacity>
        </View>
